...
/******/ 	var hotCurrentHash = "545f1aa89c52c809323d"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appReducer = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Follower = __webpack_require__(191);

	var _Follower2 = _interopRequireDefault(_Follower);

	var _Subscribe = __webpack_require__(192);
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            followers.map(function (follower, i) {
	              return _react2.default.createElement(_Follower2.default, { key: i, name: follower.name });
	            })
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Follower = function (_React$Component) {
	  ...
	  function Follower() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Follower).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Subscribe, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { className: 'btn btn-info', onClick: this.handleSubscription.bind(this) },
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({
	    subscribe: _follow.follow
	  }, dispatch);
	};

	exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(Subscribe);
...
/***/ function(module, exports) {
	...
	var follow = exports.follow = function follow(name, isSubscribed) {
	  if (isSubscribed) {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _followers = __webpack_require__(195);
...
/***/ function(module, exports) {
	...
	var followers = function followers() {
	  ...
	  switch (action.type) {
	    ...
	    case 'ADD_FOLLOWER':
	      var newPerson = { name: action.person };
	      return [].concat(_toConsumableArray(state), [newPerson]);

	    case 'REMOVE_FOLLOWER':
	      return state.filter(function (person) {
	        return person.name !== action.person;
	      });

	    // INITIAL STATE
	    default:
	      return [{ name: 'Uriel' }, { name: 'Allison' }, { name: 'Chander' }, { name: 'John Doe' }];
	  }
	};
